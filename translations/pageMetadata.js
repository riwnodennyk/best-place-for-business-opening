export const pageMetadata = {
    "en": {
        "pageTitle": "Free Foot Traffic Estimator | Plan Your New Business Location",
    ...
    "zh": {
        ...
        "metaDescription": "使用我们的免费互动地图估算您的商业位置人流量。",
        "keywords": "人流量，计算器，免费，工具，商业位置，客户流量，店铺规划，零售选址，商业地产，餐厅，办公室，互动地图，估算，分析，数据，规划，店铺，餐厅，办公室，真实世界数据",
    ...
    "es": {
        ...
        "keywords": "tráfico peatonal, calculadora, gratis, herramienta, ubicación comercial, flujo de clientes, planificación de tiendas, selección de sitios minoristas, bienes raíces comerciales, restaurante, oficina, mapa interactivo, estimación, análisis, datos, plan, tienda, restaurante, oficina, datos del mundo real",
    ...
    "ar": {
        ...
        "keywords": "حركة المشاة، حاسبة، مجاني، أداة، موقع العمل، تدفق العملاء، تخطيط المتجر، اختيار موقع البيع بالتجزئة، العقارات التجارية، مطعم، مكتب، خريطة تفاعلية، تقدير، تحليل، بيانات، خطة، متجر، مطعم، مكتب، بيانات العالم الحقيقي",
    ...
    "id": {
        ...
        "keywords": "lalu lintas pejalan kaki, kalkulator, gratis, alat, lokasi bisnis, aliran pelanggan, perencanaan toko, pemilihan situs ritel, real estat komersial, restoran, kantor, peta interaktif, perkiraan, analisis, data, rencana, toko, restoran, kantor, data dunia nyata",
    ...
    "ms": {
        ...
        "keywords": "lalu lintas pejalan kaki, kalkulator, percuma, alat, lokasi perniagaan, aliran pelanggan, perancangan kedai, pemilihan tapak runcit, hartanah komersial, restoran, pejabat, peta interaktif, anggaran, analisis, data, rancangan, kedai, restoran, pejabat, data dunia sebenar",
    ...
    "pt": {
        ...
        "metaDescription": "Estime o tráfego de pedestres para o local do seu negócio usando nosso mapa interativo gratuito.",
        "keywords": "tráfego de pedestres, calculadora, grátis, ferramenta, localização comercial, fluxo de clientes, planejamento de loja, seleção de sites de varejo, imóveis comerciais, restaurante, escritório, mapa interativo, estimativa, análise, dados, plano, loja, restaurante, escritório, dados do mundo real",
    ...
    "fr": {
        ...
        "keywords": "trafic piéton, calculatrice, gratuit, outil, emplacement commercial, flux de clients, planification de magasin, sélection de sites de vente au détail, immobilier commercial, restaurant, bureau, carte interactive, estimation, analyse, données, plan, magasin, restaurant, bureau, données du monde réel",
    ...
    "ja": {
        ...
        "metaDescription": "無料のインタラクティブマップを使用して、ビジネスの立地の歩行者数を推定します。",
        "keywords": "歩行者交通量、計算機、無料、ツール、ビジネスの場所、顧客の流れ、店舗計画、小売サイト選択、商業不動産、レストラン、オフィス、インタラクティブマップ、推定、分析、データ、計画、店舗、レストラン、オフィス、実世界のデータ",
    ...
    "ru": {
        ...
        "metaDescription": "Оцените поток пешеходов для вашего бизнеса с помощью нашей бесплатной интерактивной карты.",
        "keywords": "поток пешеходов, калькулятор, бесплатно, инструмент, местоположение бизнеса, поток клиентов, планирование магазина, выбор места для розничной торговли, коммерческая недвижимость, ресторан, офис, интерактивная карта, оценка, анализ, данные, план, магазин, ресторан, офис, данные реального мира",
    ...
    "de": {
        ...
        "keywords": "Fußgängertraffic, Rechner, kostenlos, Werkzeug, Geschäftsstandort, Kundenstrom, Ladenplanung, Einzelhandelsstandortwahl, Gewerbeimmobilien, Restaurant, Büro, interaktive Karte, Schätzung, Analyse, Daten, Plan, Laden, Restaurant, Büro, reale Daten",
    ...
    "bn": {
        ...
        "metaDescription": "আমাদের বিনামূল্যে ইন্টারেক্টিভ মানচিত্র ব্যবহার করে আপনার ব্যবসার স্থানের পথচারী ট্র্যাফিক অনুমান করুন।",
        "keywords": "পথচারী ট্র্যাফিক, ক্যালকুলেটর, বিনামূল্যে, সরঞ্জাম, ব্যবসার স্থান, গ্রাহক প্রবাহ, দোকান পরিকল্পনা, খুচরা সাইট নির্বাচন, বাণিজ্যিক রিয়েল এস্টেট, রেস্তোরাঁ, অফিস, ইন্টারেক্টিভ মানচিত্র, অনুমান, বিশ্লেষণ, তথ্য, পরিকল্পনা, দোকান, রেস্তোরাঁ, অফিস, বাস্তব বিশ্বের তথ্য",
    ...
    "hi": {
        ...
        "keywords": "पैदल यातायात, कैलकुलेटर, मुफ्त, उपकरण, व्यवसाय स्थान, ग्राहक प्रवाह, स्टोर योजना, खुदरा साइट चयन, वाणिज्यिक रियल एस्टेट, रेस्तरां, कार्यालय, इंटरैक्टिव नक्शा, अनुमान, विश्लेषण, डेटा, योजना, स्टोर, रेस्तरां, कार्यालय, वास्तविक दुनिया डेटा",
    ...
    "ko": {
        ...
        "keywords": "보행자 교통, 계산기, 무료, 도구, 비즈니스 위치, 고객 흐름, 매장 계획, 소매 사이트 선택, 상업 부동산, 레스토랑, 사무실, 인터랙티브 지도, 추정, 분석, 데이터, 계획, 매장, 레스토랑, 사무실, 실세계 데이터",
    ...
    "it": {
        ...
        "keywords": "traffico pedonale, calcolatore, gratuito, strumento, posizione commerciale, flusso di clienti, pianificazione del negozio, selezione del sito di vendita al dettaglio, immobili commerciali, ristorante, ufficio, mappa interattiva, stima, analisi, dati, piano, negozio, ristorante, ufficio, dati del mondo reale",
    ...
    "tr": {
        ...
        "keywords": "yaya trafiği, hesap makinesi, ücretsiz, araç, iş yeri konumu, müşteri akışı, mağaza planlama, perakende site seçimi, ticari gayrimenkul, restoran, ofis, interaktif harita, tahmin, analiz, veri, plan, mağaza, restoran, ofis, gerçek dünya verileri",
    ...
    "vi": {
        ...
        "keywords": "lưu lượng người đi bộ, máy tính, miễn phí, công cụ, địa điểm kinh doanh, luồng khách hàng, lập kế hoạch cửa hàng, lựa chọn địa điểm bán lẻ, bất động sản thương mại, nhà hàng, văn phòng, bản đồ tương tác, ước lượng, phân tích, dữ liệu, kế hoạch, cửa hàng, nhà hàng, văn phòng, dữ liệu thực tế",
    ...
    "fa": {
        ...
        "keywords": "ترافیک عابران پیاده، ماشین‌حساب، رایگان، ابزار، مکان کسب‌وکار، جریان مشتریان، برنامه‌ریزی فروشگاه، انتخاب محل خرده‌فروشی، املاک تجاری، رستوران، دفتر، نقشه تعاملی، تخمین، تحلیل، داده‌ها، برنامه، فروشگاه، رستوران، دفتر، داده‌های دنیای واقعی",
    ...
    "th": {
        ...
        "keywords": "การจราจรเท้าเดิน, เครื่องคิดเลข, ฟรี, เครื่องมือ, สถานที่ตั้งธุรกิจ, การไหลของลูกค้า, การวางแผนร้านค้า, การเลือกสถานที่ค้าปลีก, อสังหาริมทรัพย์เชิงพาณิชย์, ร้านอาหาร, สำนักงาน, แผนที่โต้ตอบ, การประเมิน, การวิเคราะห์, ข้อมูล, แผน, ร้านค้า, ร้านอาหาร, สำนักงาน, ข้อมูลโลกแห่งความจริง",
    ...
    "ur": {
        ...
        "keywords": "پیدل ٹریفک، کیلکولیٹر، مفت، آلہ، کاروبار کا مقام، صارفین کا بہاؤ، دکان کی منصوبہ بندی، خوردہ سائٹ کا انتخاب، کمرشل رئیل اسٹیٹ، ریستوراں، دفتر، انٹرایکٹو نقشہ، تخمینہ، تجزیہ، ڈیٹا، منصوبہ، دکان، ریستوراں، دفتر، حقیقی دنیا کا ڈیٹا",
    ...
    "pl": {
        ...
        "metaDescription": "Oszacuj ruch pieszy dla lokalizacji Twojego biznesu za pomocą naszej darmowej interaktywnej mapy.",
        "keywords": "ruch pieszy, kalkulator, darmowy, narzędzie, lokalizacja biznesowa, przepływ klientów, planowanie sklepu, wybór lokalizacji detalicznej, nieruchomości komercyjne, restauracja, biuro, mapa interaktywna, oszacowanie, analiza, dane, plan, sklep, restauracja, biuro, dane rzeczywiste",
    ...
    "nl": {
        ...
        "keywords": "voetgangersverkeer, calculator, gratis, hulpmiddel, bedrijfslocatie, klantenstroom, winkelplanning, detailhandel locatiekeuze, commercieel vastgoed, restaurant, kantoor, interactieve kaart, schatting, analyse, gegevens, plan, winkel, restaurant, kantoor, real-world gegevens",
    ...
    "fil": {
        ...
        "keywords": "trapikong pang-paa, kalkulator, libre, kasangkapan, lokasyon ng negosyo, daloy ng customer, pagpaplano ng tindahan, pagpili ng retail site, komersyal na real estate, restawran, opisina, interactive na mapa, pagtatantya, pagsusuri, datos, plano, tindahan, restawran, opisina, datos ng totoong mundo",
    ...
    "ro": {
        ...
        "keywords": "trafic pietonal, calculator, gratuit, instrument, locație afacere, flux de clienți, planificare magazin, selecție site retail, imobiliare comerciale, restaurant, birou, hartă interactivă, estimare, analiză, date, plan, magazin, restaurant, birou, date din lumea reală",
    ...
    "uk": {
        ...
        "metaDescription": "Оцініть пішохідний трафік для вашого бізнесу за допомогою нашої безкоштовної інтерактивної карти.",
        "keywords": "пішохідний трафік, калькулятор, безкоштовно, інструмент, місце бізнесу, потік клієнтів, планування магазину, вибір місця для роздрібної торгівлі, комерційна нерухомість, ресторан, офіс, інтерактивна карта, оцінка, аналіз, дані, план, магазин, ресторан, офіс, реальні дані",
    ...
    "el": {
        ...
        "keywords": "κυκλοφορία πεζών, υπολογιστής, δωρεάν, εργαλείο, τοποθεσία επιχείρησης, ροή πελατών, σχεδιασμός καταστήματος, επιλογή τοποθεσίας λιανικής, εμπορικά ακίνητα, εστιατόριο, γραφείο, διαδραστικός χάρτης, εκτίμηση, ανάλυση, δεδομένα, σχέδιο, κατάστημα, εστιατόριο, γραφείο, δεδομένα πραγματικού κόσμου",
    ...
    "cs": {
        ...
        "keywords": "pěší provoz, kalkulačka, zdarma, nástroj, umístění podniku, tok zákazníků, plánování obchodu, výběr maloobchodního místa, komerční nemovitosti, restaurace, kancelář, interaktivní mapa, odhad, analýza, data, plán, obchod, restaurace, kancelář, reálná data",
    ...
    "hu": {
        ...
        "keywords": "gyalogos forgalom, számológép, ingyenes, eszköz, üzleti helyszín, ügyféláramlás, üzlet tervezés, kiskereskedelmi helyszínválasztás, kereskedelmi ingatlan, étterem, iroda, interaktív térkép, becslés, elemzés, adatok, terv, üzlet, étterem, iroda, valós adatok",
    ...
    "sv": {
        ...
        "keywords": "fottrafik, kalkylator, gratis, verktyg, affärslokation, kundflöde, butiksplanering, val av detaljhandelsplats, kommersiella fastigheter, restaurang, kontor, interaktiv karta, uppskattning, analys, data, plan, butik, restaurang, kontor, verklighetsdata",
    ...
    "he": {
        ...
        "keywords": "תנועת רגליים, מחשבון, חינם, כלי, מיקום עסקי, זרימת לקוחות, תכנון חנות, בחירת אתר קמעונאי, נדל\"ן מסחרי, מסעדה, משרד, מפה אינטראקטיבית, הערכה, ניתוח, נתונים, תוכנית, חנות, מסעדה, משרד, נתוני העולם האמיתי",
    ...
    "da": {
        ...
        "keywords": "fodgængertrafik, lommeregner, gratis, værktøj, forretningslokation, kundestrøm, butiksplanlægning, valg af detailhandelssted, kommercielle ejendomme, restaurant, kontor, interaktivt kort, estimering, analyse, data, plan, butik, restaurant, kontor, virkelighedsdata",
    ...
    "fi": {
        ...
        "keywords": "jalankulkuliikenne, laskin, ilmainen, työkalu, liiketilan sijainti, asiakasvirta, myymälän suunnittelu, vähittäiskaupan paikan valinta, kaupalliset kiinteistöt, ravintola, toimisto, interaktiivinen kartta, arvio, analyysi, tiedot, suunnitelma, myymälä, ravintola, toimisto, tosimaailman tiedot",
    ...
    "no": {
        ...
        "keywords": "fottrafikk, kalkulator, gratis, verktøy, forretningslokasjon, kundestrøm, butikkplanlegging, valg av detaljhandelssted, næringseiendom, restaurant, kontor, interaktivt kart, estimering, analyse, data, plan, butikk, restaurant, kontor, virkelighetsdata",
    ...
    "bg": {
        ...
        "keywords": "пешеходен трафик, калкулатор, безплатен, инструмент, бизнес местоположение, поток от клиенти, планиране на магазин, избор на място за търговия на дребно, търговски имоти, ресторант, офис, интерактивна карта, оценка, анализ, данни, план, магазин, ресторант, офис, данни от реалния свят",
    ...
    "sk": {
        ...
        "metaDescription": "Odhadnite pešiu premávku pre umiestnenie vášho podniku pomocí naší bezplatné interaktivní mapy.",
        "keywords": "pešia premávka, kalkulačka, bezplatný, nástroj, umiestnenie podniku, tok zákazníkov, plánovanie obchodu, výber miesta pre maloobchod, komerčné nehnuteľnosti, reštaurácia, kancelária, interaktívna mapa, odhad, analýza, údaje, plán, obchod, reštaurácia, kancelária, reálne údaje",
    ...
    "hr": {
        ...
        "keywords": "pješački promet, kalkulator, besplatno, alat, lokacija poslovanja, tok kupaca, planiranje trgovine, odabir maloprodajnog mjesta, komercijalne nekretnine, restoran, ured, interaktivna karta, procjena, analiza, podaci, plan, trgovina, restoran, ured, podaci iz stvarnog svijeta",
    ...
    "sr": {
        ...
        "keywords": "пешачки саобраћај, калкулатор, бесплатно, алат, локација посла, ток купаца, планирање продавнице, избор малопродајног места, комерцијалне некретнине, ресторан, канцеларија, интерактивна мапа, процена, анализа, подаци, план, продавница, ресторан, канцеларија, подаци из стварног света",
    ...
    "lt": {
        ...
        "keywords": "pėsčiųjų eismas, skaičiuotuvas, nemokamas, įrankis, verslo vieta, klientų srautas, parduotuvės planavimas, mažmeninės prekybos vietos pasirinkimas, komercinis nekilnojamasis turtas, restoranas, biuras, interaktyvus žemėlapis, vertinimas, analizė, duomenys, planas, parduotuvė, restoranas, biuras, realaus pasaulio duomenys",
    ...
    "sl": {
        ...
        "keywords": "peš promet, kalkulator, brezplačno, orodje, lokacija poslovanja, tok strank, načrtovanje trgovine, izbira maloprodajnega mesta, komercialne nepremičnine, restavracija, pisarna, interaktivni zemljevid, ocena, analiza, podatki, načrt, trgovina, restavracija, pisarna, podatki iz resničnega sveta",
    ...
    "lv": {
        ...
        "keywords": "gājēju plūsma, kalkulators, bezmaksas, rīks, biznesa vieta, klientu plūsma, veikala plānošana, mazumtirdzniecības vietas izvēle, komerciālais nekustamais īpašums, restorāns, birojs, interaktīvā karte, novērtējums, analīze, dati, plāns, veikals, restorāns, birojs, reālās pasaules dati",
    ...
    "et": {
        ...
        "keywords": "jalakäijate liiklus, kalkulaator, tasuta, tööriist, ärikoht, klientide vool, poe planeerimine, jaemüügikoha valik, kommertskinnisvara, restoran, kontor, interaktiivne kaart, hinnang, analüüs, andmed, plaan, pood, restoran, kontor, reaalse maailma andmed",
    ...
    "hy": {
        ...
        "metaDescription": "Գնահատեք հետիոտնային երթևեկությունը Ձեր բիզնեսի գտնվելու վայրի համար՝ օգտագործելով մեր անվճար ինտերակտիվ քարտեզը:",
        "keywords": "հետիոտնային երթևեկություն, հաշվիչ, անվճար, գործիք, բիզնեսի գտնվելու վայր, հաճախորդների հոսք, խանութի պլանավորում, մանրածախ վայրի ընտրություն, առևտրային անշարժ գույք, ռեստորան, գրասենյակ, ինտերակտիվ քարտեզ, գնահատում, վերլուծություն, տվյալներ, պլան, խանութ, ռեստորան, գրասենյակ, իրական աշխարհի տվյալներ",
    ...
    "az": {
        ...
        "keywords": "piyada trafiki, kalkulyator, pulsuz, alət, biznes yeri, müştəri axını, mağaza planlaşdırma, pərakəndə satış yerinin seçimi, kommersiya daşınmaz əmlakı, restoran, ofis, interaktiv xəritə, təxmin, təhlil, məlumatlar, plan, mağaza, restoran, ofis, real dünya məlumatları",
    ...
    "ka": {
        ...
        "keywords": "ფეხით მოსიარულეთა ტრაფიკი, კალკულატორი, უფასო, ინსტრუმენტი, ბიზნესის ადგილმდებარეობა, მომხმარებელთა ნაკადი, მაღაზიის დაგეგმვა, საცალო ვაჭრობის ადგილის შერჩევა, კომერციული უძრავი ქონება, რესტორანი, ოფისი, ინტერაქტიული რუკა, შეფასება, ანალიზი, მონაცემები, გეგმა, მაღაზია, რესტორანი, ოფისი, რეალური სამყაროს მონაცემები",
    ...
    "sq": {
        ...
        "keywords": "trafiku i këmbësorëve, llogaritës, falas, mjet, vendndodhja e biznesit, rrjedha e klientëve, planifikimi i dyqanit, zgjedhja e vendit me pakicë, pasuri të paluajtshme tregtare, restorant, zyrë, hartë interaktive, vlerësim, analizë, të dhëna, plan, dyqan, restorant, zyrë, të dhëna të botës reale",
    ...
    "mk": {
        ...
        "keywords": "пешачки сообраќај, калкулатор, бесплатно, алатка, локација на бизнисот, проток на клиенти, планирање на продавница, избор на малопродажно место, комерцијални недвижности, ресторан, канцеларија, интерактивна мапа, проценка, анализа, податоци, план, продавница, ресторан, канцеларија, податоци од реалниот свет",
    ...
    "bs": {
        ...
        "keywords": "pješački saobraćaj, kalkulator, besplatno, alat, lokacija poslovanja, tok kupaca, planiranje prodavnice, izbor maloprodajnog mjesta, komercijalne nekretnine, restoran, kancelarija, interaktivna mapa, procjena, analiza, podaci, plan, prodavnica, restoran, kancelarija, podaci iz stvarnog svijeta",
    ...
    "mt": {
        ...
        "keywords": "traffiku tal-mixi, kalkulatur, bla ħlas, għodda, lokazzjoni tan-negozju, fluss tal-klijenti, ippjanar tal-ħanut, għażla tas-sit tal-bejgħ bl-imnut, proprjetà kummerċjali, restorant, uffiċċju, mappa interattiva, stima, analiżi, dejta, pjan, ħanut, restorant, uffiċċju, dejta tad-dinja reali",
    ...
    "lb": {
        ...
        "keywords": "Foussgängertrafik, Rechner, gratis, Tool, Geschäftsplaz, Clientenfluss, Geschäftsplanzung, Wiel vun engem Verkafsstandort, kommerziell Immobilien, Restaurant, Büro, interaktiv Kaart, Schätzung, Analyse, Donnéeën, Plang, Geschäft, Restaurant, Büro, real Welt Donnéeën",
    ...
    "km": {
        ...
        "keywords": "ចរាចរណ៍ជើង, ម៉ាស៊ីនគណនា, ឥតគិតថ្លៃ, ឧបករណ៍, ទីតាំងអាជីវកម្ម, លំហូរអតិថិជន, ការរៀបចំផែនការហាង, ការជ្រើសរើសទីតាំងលក់រាយ, អចលនទ្រព្យពាណិជ្ជកម្ម, ភោជនីយដ្ឋាន, ការិយាល័យ, ផែនទីអន្តរកម្ម, ការប៉ាន់ស្មាន, ការវិភាគ, ទិន្នន័យ, ផែនការ, ហាង, ភោជនីយដ្ឋាន, ការិយាល័យ, ទិន្នន័យពិភពលោកពិត",
